            ...
            .map((item, index) => {
              ...
              return (
                <div key={index} className="p-4 md:w-1/4">
                  <div
                    className={`flex flex-col h-full border-2 hover:shadow-gray-100 hover:shadow-2xl transition-shadow duration-300 ease-in-out border-gray-200 border-opacity-60 rounded-2xl overflow-hidden ${
                  ...
                  >
                    ...
                    <div className="flex flex-col justify-between flex-grow p-5 border-t-2 h-full">
